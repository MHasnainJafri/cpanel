...
class CpanelServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../resources/lang', 'cpanel');
        ...
        if ($this->app->runningInConsole()) {
            ...
            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/cpanel'),
            ], 'assets');*/

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/cpanel'),
            ], 'lang');*/
    ...
    public function register()
    {
        ...
        $this->app->singleton('cpanel', function () {
            return new Cpanel;
        });
    }
}
